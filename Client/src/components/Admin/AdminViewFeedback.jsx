...
export default function AdminViewUsersFeedback() {
    ...
    const sentimentColors = {
        ...
        happiness: "bg-green-200 text-green-700",
        fun: "bg-yellow-200 text-yellow-700",
        relief: "bg-blue-200 text-blue-700",
        enthusiasm: "bg-purple-200 text-purple-700",
        neutral: "bg-gray-200 text-gray-700",
        worry: "bg-orange-200 text-orange-700",
        anger: "bg-red-200 text-red-700",
        hate: "bg-black text-white"
    };
                    ...
                    {feedbacks.map((fb) => (
                        <div key={fb._id} className="border rounded-lg shadow p-4 bg-white hover:shadow-lg transition">
                            ...
                            <p className="mb-2">
                                ...
                                <span className={`px-2 py-1 rounded-full text-sm font-medium ${sentimentColors[fb.sentiment] || "bg-gray-200 text-gray-700"}`}>
                                    {fb.sentiment || "Not Analyzed"}
                                </span>
                            </p>
